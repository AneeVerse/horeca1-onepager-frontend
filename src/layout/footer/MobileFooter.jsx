...
const MobileFooter = ({ globalSetting, categories, categoryError }) => {
  ...
  return (
    <>
      ...
      <footer className="sm:hidden fixed z-50 bottom-0 bg-primary-500 flex items-center justify-around w-full h-16 px-2 shadow-lg">
        {/* Home - First */}
        <Link
          href="/"
        ...
        >
          <div className="w-6 h-6 flex items-center justify-center transition-transform duration-200 group-active:scale-110">
            <svg
              className="w-6 h-6 fill-white drop-shadow-lg"
              viewBox="0 0 24 24"
          ...
          <span className="text-[10px] text-white mt-0.5 font-medium">WhatsApp</span>
        </a>
