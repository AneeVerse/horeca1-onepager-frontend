export const storeCustomization = {
  ...
  home: {
    ...
    promotion_title: {
      en: "100% Natural Quality Product",
      de: "100 % natürliches Qualitätsprodukt",
    },
    ...
    quick_delivery_description: {
      en: "There are many products you will find in our shop. Choose your daily necessary product from our horeca1 shop and get some special offers. See our latest discounted products here and get a special discount.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem horeca1-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
    },
    ...
    daily_need_title: {
      en: "Get Your Daily Needs From Our horeca1 Store",
      de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
    },
    daily_need_description: {
      en: "There are many products you will find in our shop. Choose your daily necessary product from our horeca1 shop and get some special offers.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem horeca1-Shop und erhalten Sie einige Sonderangebote.",
    },
  ...
  faq: {
    ...
    faq_one: {
      en: "How does the horeca1 work?",
      de: "Wie funktioniert der horeca1?",
    },
    description_one: {
    ...
    faq_five: {
      en: "What is horeca1 EC2 auto scaling?",
      de: "Was ist die automatische Skalierung von horeca1 EC2?",
    },
    description_five: {
      en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
    ...
    faq_six: {
      en: "What are the benefits of using horeca1 affliate?",
  ...
  slug: {
    ...
    card_description_six: {
      en: "Guaranteed 100% quality from natural products.",
      de: "Garantiert 100 % Qualität aus Naturprodukten.",
    },
