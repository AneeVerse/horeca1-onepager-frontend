  ...
  if (isPromoTime) {
    ...
    return (
      <div className="w-full h-auto min-h-[140px] lg:h-[280px] flex">
        <div className="bg-gradient-to-br from-[#025155] via-[#025155] to-[#018549] w-full rounded-lg lg:rounded-2xl shadow-[0_20px_50px_rgba(2,81,85,0.25)] overflow-hidden relative flex flex-col border border-white/10 group transition-all duration-700">
